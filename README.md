...
- 🎓 **Education:** Undergraduate Student in Networking & Mobile Computing.
- 🛡️ **Interests:** Network Intrusion Detection Systems (NIDS), vulnerability scanning, and cybersecurity attack taxonomy.
- ☁️ **Cloud & Infrastructure:** Experienced in deploying web servers, managing metrics, and utilizing AWS ecosystem services (EC2, RDS, CloudWatch).
...
| **Operating Systems** | Windows PowerShell, Linux |
